...
deepspeed --master_port=29501 --include=localhost:4,5,7 llava/train/train_mem.py \
    ...
    --output_dir "./outputs_after_stage_2/lora_checkpoints/${lora_target_modules_str}/${current_date}_train_${max_train_samples}_mix/vision_${vision_token_attn}-llava-v1.5-7b-lora" \

#bash scripts/my_scripts/after_stage_2_finetune_lora.sh
